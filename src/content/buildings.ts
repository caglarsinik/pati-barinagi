...
export const BUILDING_DEFS: Record<BuildingType, BuildingDef> = {
  ...
  kitchen: {
    ...
    category: 'besleme',
    solidRows: 'all',
    desc: 'Yem kapları iki kat porsiyon alır; personel yemi daha hızlı hazırlar.',
    buildMinutes: 180,
    buildable: true,
  },
  bowl: {
  ...
  lamp: {
    ...
    category: 'altyapi',
    solidRows: 'all',
    desc: 'Gece çevresini aydınlatır.',
    buildMinutes: 0,
    buildable: true,
  },
  bin: {
  ...
  bench: {
    ...
    category: 'dekor',
    solidRows: 'all',
    desc: 'Sahiplenicilerin dinlendiği bank.',
    buildMinutes: 0,
    buildable: true,
  },
  sign: {
    ...
    category: 'dekor',
    solidRows: 'all',
    desc: 'Barınağın adını duyurur, itibara küçük katkı.',
    buildMinutes: 0,
    buildable: true,
  },
};
