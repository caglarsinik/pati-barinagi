...
/** Köylünün bulunabileceği yerler: ev ve iş yeri içeride (görünmez), öbürleri dışarıda. */
export type VillagerPlace = 'home' | 'work' | 'spot' | 'spot2' | 'plaza';
...
export class Villager {
  ...
  path: TilePos[] = [];
  pathed = false;
  /** Bugün kaç kez konuşuldu (satırlar sırayla gelir). */
  talks = 0;
