...
const ROWS: Array<[string, string, string]> = [
  ...
  ['↑ (kapıda basılı tut)', 'Binaya gir (ofis, dinlenme odası, kiler, mutfak, veteriner); E kapıdaki hızlı işi yapar', '–'],
...
const TOUCH_ROWS: Array<[string, string]> = [
  ...
  ['Binanın kapı karesine dokun', 'İçeri girer (ofis, dinlenme odası, kiler, mutfak, veteriner); binanın başka yerine dokunmak hızlı işi yapar'],
